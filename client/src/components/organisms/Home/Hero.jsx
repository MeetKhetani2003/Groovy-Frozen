  ...
  return (
    <div>
      <div className="relative">
        ...
        <div className="absolute top-1/2 lg:top-24 left-6 lg:left-24 flex items-center justify-center">
          ...
          <div className="lg:w-2/4 lg:ml-12 lg:mb-28">
            ...
            <span className="leading-none">
              <p className=" text-[120px] font-serif">Groovy </p>
              <p className=" text-[120px] font-serif">Cafe </p>
            </span>
